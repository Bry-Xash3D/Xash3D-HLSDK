...
CFLAGS=$(BASE_CFLAGS) $(CFG_CFLAGS) -DCLIENT_DLL -DCLIENT_WEAPONS -I/usr/include/malloc
...
# TODO: Bundle SDL2 in applesilicon folder
LDFLAGS=$(SHLIBLDFLAGS) $(CPP_LIB) -lSDL2
#-L$(CFG) vgui.so -L. libSDL2-2.0.so.0
